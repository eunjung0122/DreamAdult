	...
	<nav id="menuBer" class="navbar navbar-light navbar-expand-lg title-font">
      <div class="container">
         ...
         <div class="collapse navbar-collapse mbhdBottom" id="navbarNav">
            ...
            <div class="dropdown" style="padding-left:20px; padding-right:36px;">
               <button style="padding-left:12px !important; padding-right:6px !important;" class="btn dropdown-toggle MbDrMem" type="button"
            ...
            <%if(id != null){ %>
            	<div class="dropdown mbDrBookLeft" style="padding-right: 40px;">
